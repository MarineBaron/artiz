...
/**
 *	\file       htdocs/comartiz/template/comartizindex.php
 *	\ingroup    comartiz
 *	\brief      Home page of comartiz top menu
 */
...
$langs->loadLangs(array("comartiz@comartiz"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->comartiz->read) accessforbidden();
...
llxHeader("",$langs->trans("ComArtizArea"));

print load_fiche_titre($langs->trans("ComArtizArea"),'','comartiz.png@comartiz');
...
// Draft MyObject
if (! empty($conf->comartiz->enabled) && $user->rights->comartiz->read)
{
	$langs->load("orders");
