...
/**
 * \file    test/functional/ComArtizFunctionalTest.php
 * \ingroup comartiz
 ...
 *
 * @package Testcomartiz
 */
class ComArtizFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/comartiz/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('comartiz/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/comartiz/admin/about.php');
		$this->authenticate();
		return $this->assertContains('comartiz/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('comartizwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modComArtiz_ComArtizTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modComArtiz_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
